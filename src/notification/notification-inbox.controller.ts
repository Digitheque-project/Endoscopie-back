...
export class NotificationInboxController {
  ...
  @ApiOperation({
    ...
    description:
      "readAt est partagé entre le major et le médecin : les deux voient le même compteur " +
      "pour rester en phase (\"continuité\") — seul le clic du médecin sur une notification " +
      "de nouvelle prescription est un no-op côté frontend, pour ne pas la faire disparaître " +
      "avant que le major l'ait traitée.",
  })
  ...
  @ApiOperation({ summary: 'Marquer une notification locale comme lue (partagé major/médecin)' })
